...
In C library, there is a standard io function named min and same goes for
max which sort the minimum and maximum. In this program sorting is taken
to another context using similar logic to min
